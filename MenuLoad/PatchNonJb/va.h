...
#define DEFAULT_MACHO_PATH "Frameworks/UnityFramework.framework/UnityFramework"
#define ANOGS_MACHO_PATH "Frameworks/anogs.framework/anogs"
...
#define ActiveAnogs(vaddr, patch) \
    ActiveCodePatch(ANOGS_MACHO_PATH, vaddr, patch)

#define PatchAnogs(vaddr, patch) \
    StaticInlineHookPatch(ANOGS_MACHO_PATH, vaddr, patch)
